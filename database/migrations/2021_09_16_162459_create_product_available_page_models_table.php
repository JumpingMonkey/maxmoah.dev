...
class CreateProductAvailablePageModelsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('product_available_page_models', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('product_available_page_models');
    }
}
