...
class CareerPopupPage extends Resource
{
     ...
     * @var string
     */
    public static $model = \App\Models\CareerPopupPage::class;
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Text::make('Privacy policy link text'),
            Text::make('Privacy policy link'),
